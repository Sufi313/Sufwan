...
public class CustomProductAdapterShalwar extends RecyclerView.Adapter<CustomProductAdapterShalwar.CustomProductViewHolder> {
    ...
    public CustomProductAdapterShalwar(Context mCtx, List<CustomProduct> customProductList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(final CustomProductViewHolder holder, int position) {
        ...
        holder.selectButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (LetSelectSizePrefMngr.getInstance(mCtx).isShalwarIn()) {
                    LetSelectSizePrefMngr.getInstance(mCtx).ClearSelectShalwar();
                }

                LetSelectSizePrefMngr.getInstance(mCtx).selectShalwar(customProduct.getId(), customProduct.getName()
