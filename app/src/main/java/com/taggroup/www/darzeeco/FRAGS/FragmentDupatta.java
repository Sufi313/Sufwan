...
import com.taggroup.www.darzeeco.CustomizeAndStanderd.Adapters.CustomProductAdapterDupatta;
...
public class FragmentDupatta extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_dupatta,null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.dupattaCustomDesign);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            CustomProductAdapterDupatta adapter = new CustomProductAdapterDupatta(getContext(), customProductsList);
