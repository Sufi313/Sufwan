...
public class CustomProductAdapterFront extends RecyclerView.Adapter<CustomProductAdapterFront.CustomProductViewHolder> {
    ...
    public CustomProductAdapterFront(Context mCtx, List<CustomProduct> customProductList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(final CustomProductViewHolder holder, int position) {
        ...
        holder.selectButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (LetSelectSizePrefMngr.getInstance(mCtx).isFrontNeckIn()) {
                    LetSelectSizePrefMngr.getInstance(mCtx).ClearSelectFrontNeck();
                }

                LetSelectSizePrefMngr.getInstance(mCtx).selectFrontNeck(customProduct.getId(), customProduct.getName()
