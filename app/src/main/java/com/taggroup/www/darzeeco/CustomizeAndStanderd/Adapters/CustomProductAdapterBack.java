...
public class CustomProductAdapterBack extends RecyclerView.Adapter<CustomProductAdapterBack.CustomProductViewHolder> {
    ...
    public CustomProductAdapterBack(Context mCtx, List<CustomProduct> customProductList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(final CustomProductViewHolder holder, int position) {
        ...
        holder.selectButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (LetSelectSizePrefMngr.getInstance(mCtx).isBackNeckIn()) {
                    LetSelectSizePrefMngr.getInstance(mCtx).ClearSelectBackNeck();
                }

                LetSelectSizePrefMngr.getInstance(mCtx).selectBackNeck(customProduct.getId(), customProduct.getName()
