...
public class FragmentTrousers extends Fragment {

    private static final String URL_PRODUCTS = "http://192.168.2.41/darzee/Api2.php?apicall=Trousers";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.trousers_fragment,null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recylcerView_trousers);
