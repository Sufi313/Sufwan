...
public class CustomProductAdapterDaaman extends RecyclerView.Adapter<CustomProductAdapterDaaman.CustomProductViewHolder> {
    ...
    public CustomProductAdapterDaaman(Context mCtx, List<CustomProduct> customProductList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(final CustomProductViewHolder holder, int position) {
        ...
        holder.selectButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (LetSelectSizePrefMngr.getInstance(mCtx).isDaamanIn()) {
                    LetSelectSizePrefMngr.getInstance(mCtx).ClearSelectDaaman();
                }

                LetSelectSizePrefMngr.getInstance(mCtx).selectDaaman(customProduct.getId(), customProduct.getName()
